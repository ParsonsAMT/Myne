...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field taken on 'Course'
        db.create_table('profiles_course_taken', (
        ...
        db.create_unique('profiles_course_taken', ['course_id', 'student_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field taken on 'Course'
        db.delete_table('profiles_course_taken')
