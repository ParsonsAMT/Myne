...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Program.department'
        db.add_column('profiles_program', 'department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Department'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Program.department'
        db.delete_column('profiles_program', 'department_id')
