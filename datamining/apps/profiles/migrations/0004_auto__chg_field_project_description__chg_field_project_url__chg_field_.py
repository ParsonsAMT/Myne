...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_project', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'Project.url'
        db.alter_column('profiles_project', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))
        ...
        db.alter_column('profiles_project', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Project.description'
        db.alter_column('profiles_project', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Project.url'
        db.alter_column('profiles_project', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Project.title'
        db.alter_column('profiles_project', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Project.thumbnail'
        db.alter_column('profiles_project', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
