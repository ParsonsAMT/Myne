...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Link.person'
        db.delete_column('profiles_link', 'person_id')

        # Adding field 'Presentation.location'
        db.add_column('profiles_presentation', 'location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Link.person'
        db.add_column('profiles_link', 'person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Person'], null=True, blank=True), keep_default=False)

        # Deleting field 'Presentation.location'
        db.delete_column('profiles_presentation', 'location')
