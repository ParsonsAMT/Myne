...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('profiles_work', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='works', null=True, to=orm['profiles.WorkType'], blank=True), keep_default=False)
