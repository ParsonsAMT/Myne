...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming M2M table for field temp_expertise on 'Person'
        db.rename_table('profiles_person_temp_expertise','profiles_person_expertise')

        db.create_unique('profiles_person_expertise', ['person_id', 'expertise_id'])

    
    def backwards(self, orm):
        
        # Renaming M2M table for field expertise on 'Person'
        db.rename_table('profiles_person_expertise','profiles_person_temp_expertise')
