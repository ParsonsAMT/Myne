...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_contactemail', (
            ...
            ('recipient', self.gf('django.db.models.fields.EmailField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('profiles', ['ContactEmail'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ContactEmail'
        db.delete_table('profiles_contactemail')
