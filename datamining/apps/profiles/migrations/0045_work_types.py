...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        if not db.dry_run:
            for work in orm.Work.objects.all():
                if "film" in work.type or "Film" in work.type or "motion graphics" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "film")
                elif "campaign" in work.type or "Campaign" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "campaign")
                elif "3D" in work.type or "3d" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "computer graphics")
                elif "CG" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "computer graphics")
                elif "animation" in work.type or "Animation" in work.type or "animated" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "animation")
                elif "consultancy" in work.type or "Consultancy" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "consultancy")
                elif "book" in work.type or "Book" in work.type or "Pamphlet" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "book")
                elif "audio-visual installation" in work.type or "Audio-visual installation" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "audio-visual installation")
                elif "map" in work.type or "Map" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "map")
                elif "collage" in work.type or "Collage" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "collage")
                elif "portrait" in work.type or "Portrait" in work.type or "Portraiture" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "portrait")
                elif "concept" in work.type or "Concept" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "concept")
                elif "packaging" in work.type or "Packaging" in work.type or "package" in work.type or "Package" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "packaging")
                elif "print" in work.type or "Print" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "print")
                elif "branding" in work.type or "Branding" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "branding")
                elif "garment" in work.type or "Garment" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "garment")
                elif "visualization" in work.type or "Visualization" in work.type or "Visaulization" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "visualization")
                elif "intervention" in work.type or "Intervention" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "intervention")
                elif "game" in work.type or "Game" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "game")
                elif "exhibition" in work.type or "Exhibition" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "curated exhibit")
                elif "interactive" in work.type or "Interactive" in work.type or "interactivity" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "interactive")
                elif "toy" in work.type or "Toy" in work.type or "zoetropes" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "toy")
                elif "mobile" in work.type or "Mobile" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "mobile")
                elif "oil" in work.type or "Oil" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "painting")
                elif "online" in work.type or "Online" in work.type or "web" in work.type or "Web" in work.type or "website" in work.type or "Website" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "website")
                elif "collaboration" in work.type or "Collaboration" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "collaboration")
                elif "editorial" in work.type or "Editorial" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "edited work")
                elif "photograph" in work.type or "Photograph" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "photograph")
                elif "product" in work.type or "Product" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "product")
                elif "workshop" in work.type or "Workshop" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "workshop")
                elif "software" in work.type or "Software" in work.type or "app" in work.type or "App" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "software")
                elif "typeface" in work.type or "Typeface" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "typeface")
                elif "video" in work.type or "Video" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "video")
                elif "illustration" in work.type or "Illustration" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "illustration")
                elif "installation" in work.type or "Installation" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "installation")
                elif "design" in work.type or "Design" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "design")
                elif "thesis" in work.type or "Thesis" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "thesis")
                elif "work" in work.type:
                    work.content_type = orm.WorkType.objects.get(name = "other")
                else:
                    work.content_type = orm.WorkType.objects.get(name = "other")
                work.save()
    ...
    models = {
        ...
        'profiles.work': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'works'", 'null': 'True', 'to': "orm['profiles.WorkType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True'}),
