...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('profiles_presentation')
    ...
    def backwards(self, orm):
        ...
        db.create_table('profiles_presentation', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='presentations', to=orm['profiles.Person'])),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('profiles', ['Presentation'])
