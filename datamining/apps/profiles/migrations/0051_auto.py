...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field works on 'AreaOfStudy'
        db.create_table('profiles_areaofstudy_works', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('areaofstudy', models.ForeignKey(orm['profiles.areaofstudy'], null=False)),
            ('work', models.ForeignKey(orm['profiles.work'], null=False))
        ))
        db.create_unique('profiles_areaofstudy_works', ['areaofstudy_id', 'work_id'])

        # Adding M2M table for field works on 'Program'
        db.create_table('profiles_program_works', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('program', models.ForeignKey(orm['profiles.program'], null=False)),
            ('work', models.ForeignKey(orm['profiles.work'], null=False))
        ))
        db.create_unique('profiles_program_works', ['program_id', 'work_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field works on 'AreaOfStudy'
        db.delete_table('profiles_areaofstudy_works')

        # Removing M2M table for field works on 'Program'
        db.delete_table('profiles_program_works')
    ...
    models = {
        ...
        'profiles.areaofstudy': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'aos_groups'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Organization']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'works': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'aos_works'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Work']"})
        },
        ...
        'profiles.program': {
            ...
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'program_groups'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Organization']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'office': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'works': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'program_works'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Work']"})
        },
        'profiles.project': {
