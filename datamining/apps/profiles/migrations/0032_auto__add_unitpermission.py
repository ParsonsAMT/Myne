...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnitPermission'
        db.create_table('profiles_unitpermission', (
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='unit_permissions', to=orm['auth.User'])),
        ))
        db.send_create_signal('profiles', ['UnitPermission'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'UnitPermission'
        db.delete_table('profiles_unitpermission')
