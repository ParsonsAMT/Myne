...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_requirement', (
            ...
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requirements', to=orm['profiles.Program'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('profiles', ['Requirement'])

        # Adding M2M table for field courses on 'Requirement'
        db.create_table('profiles_requirement_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('requirement', models.ForeignKey(orm['profiles.requirement'], null=False)),
            ('course', models.ForeignKey(orm['profiles.course'], null=False))
        ))
        db.create_unique('profiles_requirement_courses', ['requirement_id', 'course_id'])

    
    def backwards(self, orm):
        
        # Deleting model 'Requirement'
        db.delete_table('profiles_requirement')

        # Removing M2M table for field courses on 'Requirement'
        db.delete_table('profiles_requirement_courses')
