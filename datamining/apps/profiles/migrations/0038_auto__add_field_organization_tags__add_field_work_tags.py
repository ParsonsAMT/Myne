...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.tags'
        db.add_column('profiles_organization', 'tags', self.gf('tagging.fields.TagField')(default='', max_length=2000), keep_default=False)

        # Adding field 'Work.tags'
        db.add_column('profiles_work', 'tags', self.gf('tagging.fields.TagField')(default='', max_length=2000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.tags'
        db.delete_column('profiles_organization', 'tags')

        # Deleting field 'Work.tags'
        db.delete_column('profiles_work', 'tags')
