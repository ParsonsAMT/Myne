...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'Course.status'
        db.alter_column('profiles_course', 'status', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True))

        # Changing field 'Course.description'
        db.alter_column('profiles_course', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Course.format'
        db.alter_column('profiles_course', 'format', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'Course.timeline'
        db.alter_column('profiles_course', 'timeline', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Course.levels'
        db.alter_column('profiles_course', 'levels', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'Course.learning_outcomes'
        db.alter_column('profiles_course', 'learning_outcomes', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Course.attributes'
        db.alter_column('profiles_course', 'attributes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Course.type'
        db.alter_column('profiles_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Course.status'
        db.alter_column('profiles_course', 'status', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Course.description'
        db.alter_column('profiles_course', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Course.format'
        db.alter_column('profiles_course', 'format', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Course.timeline'
        db.alter_column('profiles_course', 'timeline', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Course.levels'
        db.alter_column('profiles_course', 'levels', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Course.learning_outcomes'
        db.alter_column('profiles_course', 'learning_outcomes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Course.attributes'
        db.alter_column('profiles_course', 'attributes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
