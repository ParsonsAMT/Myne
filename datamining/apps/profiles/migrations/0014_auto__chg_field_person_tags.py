...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field temp_expertise on 'Person'
        db.create_table('profiles_person_temp_expertise', (
        ...
        db.create_unique('profiles_person_temp_expertise', ['person_id', 'expertise_id'])
    
    def backwards(self, orm):
        
        # Removing M2M table for field temp_expertise on 'Person'
        db.delete_table('profiles_person_temp_expertise')
