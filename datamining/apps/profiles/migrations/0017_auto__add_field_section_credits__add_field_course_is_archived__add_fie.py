...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.credits'
        db.add_column('profiles_section', 'credits', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Course.is_archived'
        db.add_column('profiles_course', 'is_archived', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Course.credit_range_type'
        db.add_column('profiles_course', 'credit_range_type', self.gf('django.db.models.fields.CharField')(default='no', max_length=2), keep_default=False)

        # Adding field 'Course.archived_at'
        db.add_column('profiles_course', 'archived_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Course.maximum_credits'
        db.add_column('profiles_course', 'maximum_credits', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Course.minimum_credits'
        db.add_column('profiles_course', 'minimum_credits', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Section.credits'
        db.delete_column('profiles_section', 'credits')

        # Deleting field 'Course.is_archived'
        db.delete_column('profiles_course', 'is_archived')

        # Deleting field 'Course.credit_range_type'
        db.delete_column('profiles_course', 'credit_range_type')

        # Deleting field 'Course.archived_at'
        db.delete_column('profiles_course', 'archived_at')

        # Deleting field 'Course.maximum_credits'
        db.delete_column('profiles_course', 'maximum_credits')

        # Deleting field 'Course.minimum_credits'
        db.delete_column('profiles_course', 'minimum_credits')
