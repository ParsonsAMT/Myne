...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.homeprogram'
        db.add_column('profiles_student', 'homeprogram', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Program'], null=True, blank=True), keep_default=False)

        # Changing field 'Section.use_as_demo'
        db.alter_column('profiles_section', 'use_as_demo', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Course.is_archived'
        db.alter_column('profiles_course', 'is_archived', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Student.homeprogram'
        db.delete_column('profiles_student', 'homeprogram_id')

        # Changing field 'Section.use_as_demo'
        db.alter_column('profiles_section', 'use_as_demo', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Course.is_archived'
        db.alter_column('profiles_course', 'is_archived', self.gf('django.db.models.fields.BooleanField')())
