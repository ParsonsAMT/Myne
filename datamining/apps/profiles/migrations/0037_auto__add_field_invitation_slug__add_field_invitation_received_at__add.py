...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.slug'
        db.add_column('profiles_invitation', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)

        # Adding field 'Invitation.received_at'
        db.add_column('profiles_invitation', 'received_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Invitation.accepted_at'
        db.add_column('profiles_invitation', 'accepted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.slug'
        db.delete_column('profiles_invitation', 'slug')

        # Deleting field 'Invitation.received_at'
        db.delete_column('profiles_invitation', 'received_at')

        # Deleting field 'Invitation.accepted_at'
        db.delete_column('profiles_invitation', 'accepted_at')
