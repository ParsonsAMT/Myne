...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_organization', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organizations', to=orm['profiles.OrganizationType'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('profiles', ['Organization'])

        # Adding model 'OrganizationType'
        db.create_table('profiles_organizationtype', (
        ...
        db.send_create_signal('profiles', ['OrganizationType'])

        # Adding model 'Staff'
        db.create_table('profiles_staff', (
        ...
        db.send_create_signal('profiles', ['Staff'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_organizationtype')

        # Deleting model 'Staff'
        db.delete_table('profiles_staff')
