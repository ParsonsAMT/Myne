...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_sponsorship', (
            ...
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsorships', to=orm['profiles.Organization'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('profiles', ['Sponsorship'])

        # Adding field 'Organization.logo'
        db.add_column('profiles_organization', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.office_location'
        db.add_column('profiles_staff', 'office_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.phone'
        db.add_column('profiles_staff', 'phone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.job_description'
        db.add_column('profiles_staff', 'job_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Sponsorship'
        db.delete_table('profiles_sponsorship')

        # Deleting field 'Organization.logo'
        db.delete_column('profiles_organization', 'logo')

        # Deleting field 'Staff.office_location'
        db.delete_column('profiles_staff', 'office_location')

        # Deleting field 'Staff.phone'
        db.delete_column('profiles_staff', 'phone')

        # Deleting field 'Staff.job_description'
        db.delete_column('profiles_staff', 'job_description')
