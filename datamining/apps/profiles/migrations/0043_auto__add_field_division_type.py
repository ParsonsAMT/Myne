...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Division.type'
        db.add_column('profiles_division', 'type', self.gf('django.db.models.fields.CharField')(default='ot', max_length=2), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Division.type'
        db.delete_column('profiles_division', 'type')
