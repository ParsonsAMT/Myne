...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.division'
        db.add_column('profiles_subject', 'division', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Division'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Subject.division'
        db.delete_column('profiles_subject', 'division_id')
