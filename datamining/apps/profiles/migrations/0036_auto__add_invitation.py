...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations_sent', to=orm['profiles.Person'])),
            ('guest', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invitations_received', null=True, to=orm['profiles.Person'])),
        ...
        db.send_create_signal('profiles', ['Invitation'])


    def backwards(self, orm):
        
        # Deleting model 'Invitation'
        db.delete_table('profiles_invitation')
