...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field courses on 'Organization'
        db.create_table('profiles_organization_courses', (
        ...
        db.create_unique('profiles_organization_courses', ['organization_id', 'course_id'])

        # Adding M2M table for field projects on 'Organization'
        db.create_table('profiles_organization_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['profiles.organization'], null=False)),
            ('project', models.ForeignKey(orm['profiles.project'], null=False))
        ))
        db.create_unique('profiles_organization_projects', ['organization_id', 'project_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field courses on 'Organization'
        db.delete_table('profiles_organization_courses')

        # Removing M2M table for field projects on 'Organization'
        db.delete_table('profiles_organization_projects')
    ...
    models = {
        ...
        'profiles.organization': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leaders': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'org_leaders'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Person']"}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'org_members'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['profiles.Person']"}),
