...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AreaOfStudy'
        db.create_table('profiles_areaofstudy', (
        ...
        db.send_create_signal('profiles', ['AreaOfStudy'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AreaOfStudy'
        db.delete_table('profiles_areaofstudy')
