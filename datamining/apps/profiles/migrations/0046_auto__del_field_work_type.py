...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profiles_work', 'type')

        # Adding M2M table for field type on 'Work'
        db.create_table('profiles_work_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('work', models.ForeignKey(orm['profiles.work'], null=False)),
            ('worktype', models.ForeignKey(orm['profiles.worktype'], null=False))
        ))
        db.create_unique('profiles_work_type', ['work_id', 'worktype_id'])
    
    
    def backwards(self, orm):
        
        # Adding field 'Work.type'
        db.add_column('profiles_work', 'type', self.gf('django.db.models.fields.CharField')(default='work', max_length=255), keep_default=False)

        # Removing M2M table for field type on 'Work'
        db.delete_table('profiles_work_type')
    ...
    models = {
        ...
        'profiles.work': {
            ...
            'tags': ('tagging.fields.TagField', [], {'max_length': '2000'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['profiles.WorkType']", 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'year': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
