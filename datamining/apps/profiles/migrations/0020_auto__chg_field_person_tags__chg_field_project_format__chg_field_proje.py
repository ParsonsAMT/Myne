...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.tags'
        db.alter_column('profiles_person', 'tags', self.gf('tagging.fields.TagField')(max_length=2000))

        # Changing field 'Project.format'
        db.alter_column('profiles_project', 'format', self.gf('tagging.fields.TagField')(max_length=2000))

        # Changing field 'Project.tags'
        db.alter_column('profiles_project', 'tags', self.gf('tagging.fields.TagField')(max_length=2000))

        # Changing field 'Course.tags'
        db.alter_column('profiles_course', 'tags', self.gf('tagging.fields.TagField')(max_length=2000))
    
    
    def backwards(self, orm):
        
        # Changing field 'Person.tags'
        db.alter_column('profiles_person', 'tags', self.gf('tagging.fields.TagField')(max_length=1000))

        # Changing field 'Project.format'
        db.alter_column('profiles_project', 'format', self.gf('tagging.fields.TagField')())

        # Changing field 'Project.tags'
        db.alter_column('profiles_project', 'tags', self.gf('tagging.fields.TagField')())

        # Changing field 'Course.tags'
        db.alter_column('profiles_course', 'tags', self.gf('tagging.fields.TagField')())
