...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            # Adding field 'Section.use_as_demo'
            db.add_column('profiles_section', 'use_as_demo', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
        except Exception, e:
            if e:
                print e 
            else:
        ...
        db.rename_column('profiles_project', 'course_id', 'for_course_id')
        
        # Adding M2M table for field projects on 'Course'
        db.create_table('profiles_course_projects', (
        ...
        db.create_unique('profiles_course_projects', ['course_id', 'project_id'])


    def backwards(self, orm):
        
        # Deleting field 'Section.use_as_demo'
        db.delete_column('profiles_section', 'use_as_demo')
                                                                        
        # Deleting field 'Project.for_course'
        db.rename_column('profiles_project', 'for_course_id', 'course_id')

        # Removing M2M table for field projects on 'Course'
        db.delete_table('profiles_course_projects')
