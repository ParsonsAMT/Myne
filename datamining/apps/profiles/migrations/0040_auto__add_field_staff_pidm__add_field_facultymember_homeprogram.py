...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.pidm'
        db.add_column('profiles_staff', 'pidm', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FacultyMember.homeprogram'
        db.add_column('profiles_facultymember', 'homeprogram', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Program'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Staff.pidm'
        db.delete_column('profiles_staff', 'pidm')

        # Deleting field 'FacultyMember.homeprogram'
        db.delete_column('profiles_facultymember', 'homeprogram_id')
