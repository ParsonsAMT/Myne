...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_worktype', (
        ...
        db.send_create_signal('profiles', ['WorkType'])

        # Adding field 'Work.content_type'
        db.add_column('profiles_work', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='works', null=True, to=orm['profiles.WorkType']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'WorkType'
        db.delete_table('profiles_worktype')

        # Deleting field 'Work.content_type'
        db.delete_column('profiles_work', 'content_type_id')
