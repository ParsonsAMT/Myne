...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkImage.title'
        db.add_column('profiles_workimage', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'WorkImage.year'
        db.add_column('profiles_workimage', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'WorkImage.type'
        db.add_column('profiles_workimage', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'CourseImage.author'
        db.alter_column('profiles_courseimage', 'author', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'CourseImage.title'
        db.alter_column('profiles_courseimage', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'CourseImage.year'
        db.alter_column('profiles_courseimage', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True, blank=True))

        # Changing field 'Student.year'
        db.alter_column('profiles_student', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'WorkImage.title'
        db.delete_column('profiles_workimage', 'title')

        # Deleting field 'WorkImage.year'
        db.delete_column('profiles_workimage', 'year')

        # Deleting field 'WorkImage.type'
        db.delete_column('profiles_workimage', 'type')

        # Changing field 'CourseImage.author'
        db.alter_column('profiles_courseimage', 'author', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CourseImage.title'
        db.alter_column('profiles_courseimage', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CourseImage.year'
        db.alter_column('profiles_courseimage', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'Student.year'
        db.alter_column('profiles_student', 'year', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True))
