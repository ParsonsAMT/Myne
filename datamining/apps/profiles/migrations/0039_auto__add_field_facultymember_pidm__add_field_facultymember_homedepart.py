...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacultyMember.pidm'
        db.add_column('profiles_facultymember', 'pidm', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FacultyMember.homedepartment'
        db.add_column('profiles_facultymember', 'homedepartment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Department'], null=True, blank=True), keep_default=False)

        # Adding field 'FacultyMember.homedivision'
        db.add_column('profiles_facultymember', 'homedivision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Division'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacultyMember.pidm'
        db.delete_column('profiles_facultymember', 'pidm')

        # Deleting field 'FacultyMember.homedepartment'
        db.delete_column('profiles_facultymember', 'homedepartment_id')

        # Deleting field 'FacultyMember.homedivision'
        db.delete_column('profiles_facultymember', 'homedivision_id')
