...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_project', (
            ...
            ('owner_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('scope_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ...
        db.create_table('profiles_person_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profiles.person'], null=False)),
            ('project', models.ForeignKey(orm['profiles.project'], null=False))
        ))
        db.create_unique('profiles_person_projects', ['person_id', 'project_id'])

        # Adding M2M table for field projects on 'Section'
        db.create_table('profiles_section_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('section', models.ForeignKey(orm['profiles.section'], null=False)),
            ('project', models.ForeignKey(orm['profiles.project'], null=False))
        ))
        db.create_unique('profiles_section_projects', ['section_id', 'project_id'])
        ...
        # Adding field 'Course.timeline'
        db.add_column('profiles_course', 'timeline', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_person_projects')

        # Removing M2M table for field projects on 'Section'
        db.delete_table('profiles_section_projects')

        # Deleting field 'Course.tags'
        db.delete_column('profiles_course', 'tags')

        # Deleting field 'Course.timeline'
        db.delete_column('profiles_course', 'timeline')
