...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_course_prerequisites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_course', models.ForeignKey(orm['profiles.course'], null=False)),
            ('to_course', models.ForeignKey(orm['profiles.course'], null=False))
        ))
        db.create_unique('profiles_course_prerequisites', ['from_course_id', 'to_course_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_course_prerequisites')
