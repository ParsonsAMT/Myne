...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Affiliation', fields ['person', 'object_id', 'content_type']
        db.delete_unique('reporting_affiliation', ['person_id', 'object_id', 'content_type_id'])

        # Adding unique constraint on 'Affiliation', fields ['person', 'role', 'object_id', 'content_type']
        db.create_unique('reporting_affiliation', ['person_id', 'role_id', 'object_id', 'content_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Affiliation', fields ['person', 'role', 'object_id', 'content_type']
        db.delete_unique('reporting_affiliation', ['person_id', 'role_id', 'object_id', 'content_type_id'])

        # Adding unique constraint on 'Affiliation', fields ['person', 'object_id', 'content_type']
        db.create_unique('reporting_affiliation', ['person_id', 'object_id', 'content_type_id'])
