...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reporting_authority', (
            ...
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authorities', to=orm['reporting.Committee'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('reporting', ['Authority'])

        # Adding field 'Affiliation.end_date'
        db.add_column('reporting_affiliation', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Affiliation.start_date'
        db.add_column('reporting_affiliation', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Authority'
        db.delete_table('reporting_authority')

        # Deleting field 'Affiliation.end_date'
        db.delete_column('reporting_affiliation', 'end_date')

        # Deleting field 'Affiliation.start_date'
        db.delete_column('reporting_affiliation', 'start_date')
