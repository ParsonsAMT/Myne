...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reporting_meeting', (
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('agenda', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('reporting', ['Meeting'])

        # Adding field 'Committee.mandate'
        db.add_column('reporting_committee', 'mandate', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Meeting'
        db.delete_table('reporting_meeting')

        # Deleting field 'Committee.mandate'
        db.delete_column('reporting_committee', 'mandate')
