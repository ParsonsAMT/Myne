...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Committee.parent'
        db.add_column('reporting_committee', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcommittees', null=True, to=orm['reporting.Committee']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Committee.parent'
        db.delete_column('reporting_committee', 'parent_id')
